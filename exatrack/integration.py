...
Dependencies: config.py, gaussian_ops.py
"""

import numpy as np
import tensorflow as tf
from .config import dtype, jit_compile
...
def get_sequences(params, initial_params, constraint_function,
    ...
    next_initial_hidden_var_coefs = tf.zeros((nb_hidden_vars, nb_hidden_vars), dtype=dtype)
